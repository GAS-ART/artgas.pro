         ...
         <div class="header__actions actions-header">
            ...
            <div class="header__contacts contacts-header">
               <div class="contacts-header__row">
                  <div class="contacts-header__title-text">Контакти</div>
                  <div class="contacts-header__contacts">
                     <div class="contacts-header__body">
                        ...
                        <div class="contacts-header__social">
                           <a href="https://github.com/GAS-ART" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" fill="#000000"
                        ...
                        <div class="contacts-header__address">Дніпро, Україна</div>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="burger__body">
                  ...
                  <div class="contacts-burger__contacts">
                     ...
                     <div class="contacts-burger__social social-burger">
                        ...
                        <a href="https://https://github.com/GAS-ART" target="_blank"
                           class="social-burger__github _icon-facebook">github
                        </a>
                     </div>
                  </div>
               </div>
               <nav class="burger__menu menu-burger">
                  <ul class="menu-burger__list">
                     <li data-popup-id="lead" class="menu-burger__item link-on-popup">Зворотній зв'язок</li>
                  </ul>
               </nav>
            </div>
         </div>
